package hackerRank;//Problem: https://www.hackerrank.com/challenges/luck-balance
//Java 8
/*
Initial Thoughts:
...
interviewPreparations.Time Complexity: O(n log(n)) //We have to sort the important contest then do n iterations
